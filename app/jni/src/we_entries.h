...
static const we_t WEBSITE_ENTRIES[] = {
	{
		...
		.name = "/e/",
		.query = "e",
		.url = "https://doc.e.foundation/workspace/create-account#how-can-i-delete-my-murena-workspace-account",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "17TRACK",
		.query = "17track",
		.url = "https://help.17track.net/hc/articles/360061466432",
		.email = NULL,
		.difficulty = 0x1000
	},
	{
	...
	},
	{
		...
		.name = "7plus",
		.query = "7plus",
		.url = "https://support.7plus.com.au/hc/articles/27058368473741",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "99designs",
		.query = "99designs",
		.url = "https://support.99designs.com/hc/articles/27848116950036",
		.email = NULL,
		.difficulty = 0x1000
	},
	{
	...
	},
	{
		...
		.name = "ABOUT YOU",
		.query = "about you",
		.url = "https://aboutyou.com/h/my-account/q-360014814179",
		.email = "mailto:dataprotectionofficer@aboutyou.com",
		.difficulty = 0x1000
	},
	{
		.id = 0x1c,
	...
	},
	{
		...
		.name = "ACI Learning",
		.query = "aci learning",
		.url = "https://app.acilearning.com/account",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "Discord",
		.query = "discord",
		.url = "https://support.discord.com/hc/articles/212500837",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "Disney+",
		.query = "disney",
		.url = "https://help.disneyplus.com/article/disneyplus-delete-account",
		.email = NULL,
		.difficulty = 0x800
	},
	{
	...
	},
	{
		...
		.name = "Epieos",
		.query = "epieos",
		.url = "https://epieos.com/privacy",
		.email = "mailto:contact@epieos.com",
		.difficulty = 0x1000
	},
	{
		.id = 0x2b4,
	...
	},
	{
		...
		.name = "Keep2Share",
		.query = "keep2share",
		.url = "https://help.k2s.cc/l_eng/knowledge_base/",
		.email = NULL,
		.difficulty = 0x1000
	},
	{
	...
	{
		.id = 0x58c,
		.name = "Mobileread Forums",
		.query = "mobileread forums",
		.url = "https://www.mobileread.com/forums/sendmessage.php",
		.email = NULL,
		.difficulty = 0x2000
	},
	{
	...
	},
	{
		...
		.name = "MyDisney",
		.query = "mydisney",
		.url = "https://my.disney.com/edit/delete",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "Nexon",
		.query = "nexon",
		.url = "https://support-maplestory.nexon.com/hc/articles/360000698823",
		.email = NULL,
		.difficulty = 0x1000
	},
	{
	...
	},
	{
		...
		.name = "PentesterLab",
		.query = "pentesterlab",
		.url = "https://pentesterlab.com/my/details",
		.email = NULL,
		.difficulty = 0x400
	},
	{
	...
	},
	{
		...
		.name = "PixelEast",
		.query = "pixeleast",
		.url = "https://pixeleast.com/profile/account/manage",
		.email = NULL,
		.difficulty = 0x400
	},
	{
